...
import { MSPageTitle, MSNoData, MSConfirm } from '@/components'
...
const Rule: React.FC = () => {
  ...
  return (
      ...
      <MSConfirm
        content={
          <div>
            <h3>删除应用</h3>
            <p>
              删除 <span style={{ color: 'red' }}>手机银行1111</span>
              应用后应用中记录的所有历史变更都会被删除，确定删除吗？
            </p>
          </div>
        }
      >
    ...
    // TODO: CODE REVIEW YJH: 这些注释不用就去掉吧
    // const tempLineData = [
    //   { name: '01-31', value: 897 },
    //   { name: '02-01', value: 765 },
    //   { name: '02-02', value: 452 },
    //   { name: '02-03', value: 987 },
    //   { name: '02-04', value: 1453 },
    //   { name: '02-05', value: 699 },
    //   { name: '02-06', value: 209 }
    // ]
